        ...
        {press.map((item, i) => (
          <li key={item.href} className="border-b border-[var(--rule)]">
            <Rise delay={Math.min(i, 4) * 0.05}>
              ...
              >
                <span className="meta text-bone-faint group-hover:text-bone-muted transition-colors duration-500 lg:col-span-3">
                  {item.outlet}
                </span>
                ...
                <div className="lg:col-span-8">
                  ...
                  <p className="text-bone-muted mt-3 max-w-[64ch] text-[0.95rem] leading-relaxed">
                    {item.excerpt}
                  </p>
                </div>
                ...
                <span
                  aria-hidden
                  className="text-bone-faint group-hover:text-bone hidden justify-end pt-2 transition-colors duration-500 lg:col-span-1 lg:flex"
                >
